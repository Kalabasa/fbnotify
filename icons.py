...
icon_updating_data = open(icon_updating_path, 'rb').read() if icon_updating_path else 
icon_updating2_data = open(icon_updating2_path, 'rb').read() if icon_updating2_path else 
